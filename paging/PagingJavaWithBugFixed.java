...
class PagingJavaWithBugFixed {
  ...
  public static void main(String[] args) {
    ...
    for (int page = -10; page <= 200; ++page) {
      System.out.println("" + page + " - " + getPageWithBugFixed(l, page, pageSize));
    }
    ...
    for (int i = 1; i <= 10; ++i) {
      ...
      for (int page = -10; page <= 20000; ++page) getPageWithBugFixed(big, page, pageSize).size();
